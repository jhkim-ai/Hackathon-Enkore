<template>
<div>
    <div tabindex="0" role="dialog" class="ngdialog-content" id="modalON" style="position: fixed; display: block; top: 15%; margin-left: -196px;">
        <modal-content>
                            ...
                            <div data-tiara-layer="donation donation_detail" class="wrap_fund">
                                <dl class="list_pay">
                                    ...
                                    <dd class="info_write info_reply">
                                        <div class="wrap_tf">
                                            <textarea id="tfReply" cols="30" rows="10" name="comment" placeholder="따뜻한 한마디를 남겨주세요." data-tiara-layer="comment" data-tiara-action-name="댓글작성창_클릭" class="tf_write tf_reply ng-untouched ng-pristine ng-valid"></textarea>
                                ...
                                <div class="box_select">
                                    <span data-tiara-layer="donation donation_detail secret" data-tiara-action-name="익명기부_클릭" class="choice_comm choice_checkbox">
                                        <input type="checkbox" id="checkAnonymous" name="anonymous" class="inp_comm ng-untouched ng-pristine ng-valid" value="true">
                                    ...
                                    <span class="choice_comm choice_checkbox">
                                        <input type="checkbox" id="checkShareStory" name="share_story" class="inp_comm ng-untouched ng-pristine ng-valid">
                                    </span>
                                </div>
